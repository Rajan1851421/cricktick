        ...
        <div className='container  my-2 px-5 py-3 rounded' id='text-About' >
          ...
          <div className="row d-flex justify-content-around mt-5 align-items-center">
            ...
            <div className="col-md-3 About-box ">
              <Link to='/manualNewsGet' className='text-decoration-none text-dark'>
                <h3 className='text-center' id='h1'>Daily News Post</h3>
              </Link>
              <hr />
          ...
          <div className="row">
            <div className="col-md-12 ">
              ...
              <p className='text-left fw-400 fs-6 mt-2 mb-2 py-3  ' id='text-About' style={{ backgroundColor: 'transparent' }}>
                Welcome to our website! We are your ultimate destination for everything related to cricket news, insights, stats, live scores, and much more.
                <br /> As passionate cricket enthusiasts, we strive to provide you with the most comprehensive coverage of the sport, keeping you updated and engaged with the latest happenings in the cricketing world.
                Our team of dedicated writers and analysts works tirelessly to bring you the most accurate and up-to-date information. Whether you're a fan of international cricket, domestic leagues, or even the thriving T20 franchise tournaments, we've got you covered.
                <li>
                  We understand the excitement and anticipation that comes with following the sport, and we aim to enhance your cricketing experience by delivering high-quality content that keeps you informed and entertained.
                  Stay tuned to our website for the latest news articles, in-depth analysis, match previews, player profiles, expert opinions, and much more. We take pride in our ability to capture the essence of the game and present it to you in an engaging and informative manner.
                ...
                <li>
                  ...
                  Furthermore, we understand the importance of keeping up with live scores, especially when you can't catch the action live on television.

                </li>
                <li>
                Our dedicated live scoring section ensures that you never miss a moment, providing real-time updates, ball-by-ball commentary,
                and scorecards to keep you in the thick of the action, no matter where you are.
                </li>
